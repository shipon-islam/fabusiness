"use client";
import largeCoin from "@/assets/services/small-coin.jpg"; // Assuming you have a large coin image for the background
                    ...
                    >
                      ...
                      <div className="flex items-center gap-x-4 absolute bottom-5">
                        ...
                        <div>
                          ...
                          <h5 className="text-sm lg:text-[1rem] text-darkSlate">
                            {item.serviceUsed}
                          </h5>
                        </div>
                      </div>
